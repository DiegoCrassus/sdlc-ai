...
async def create_alert(
    ...
    return await alert_service.create_alert(session, normalized)
...
async def list_alerts(
    ...
    items = await alert_service.list_alerts(session, symbol=filter_symbol)
...
async def delete_alert(
    ...
    deleted = await alert_service.delete_alert(session, alert_id)
    if not deleted:
