...
2. Verificar aderência ao SDLC: Plane task, branch naming, base `develop`, validação e evidências.
...
6. Não aprovar progressão para merge sem Actions verdes e aprovação humana.
